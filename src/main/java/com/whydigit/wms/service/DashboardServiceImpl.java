...
public class DashboardServiceImpl implements DashboardService {
	...
	@Override
	public List<Map<String, Object>> getStockLowVolume(Long orgId, String branchCode, String client, String warehouse) {
	...
	@Override
	public List<Map<String, Object>> getBinDetails(Long orgId, String branchCode, String client, String warehouse,
			String bin) {
	...
	public List<Map<String, Object>> getGrnOrderDetails(Long orgId, String branchCode, String warehouse, String client,
		...
		Set<Object[]> getGrnOrder = stockDetailsRepo.getGrnOrderDetailsPerIn(orgId, branchCode, warehouse, client,
				finYear, month);
	...
	public List<Map<String, Object>> getOutBoundOrderPerMonth(Long orgId, String branchCode, String warehouse,
		...
		Set<Object[]> getOutBoundOrder = stockDetailsRepo.getOutBoundOrderPerMonth1(orgId, branchCode, warehouse,
				client, finYear, month);
	...
	public List<Map<String, Object>> getOutBoundOrderPerYear(Long orgId, String branchCode, String warehouse,
			String client, int finYear) {
		Set<Object[]> getOutBoundOrder = stockDetailsRepo.getOutBoundOrderPerYear1(orgId, branchCode, warehouse, client,
				finYear);
	...
	@Override
	public List<Map<String, Object>> getBinDetailsClientWiseForEmpty(Long orgId, String branchCode, String client,
			String warehouse) {
		Set<Object[]> getBinDetailsForEmpty = stockDetailsRepo.getBinDetailsClientWiseForEmpty(orgId, branchCode,
				client, warehouse);
	...
	private List<Map<String, Object>> getCriticalStockLevelDetails(Set<Object[]> getHoldMaterial) {
		List<Map<String, Object>> gridDetails1 = new ArrayList<>();
		for (Object[] grid : getHoldMaterial) {
			Map<String, Object> details = new HashMap<>();
			...
			details.put("criticalStockLevel", grid[4] != null ? Integer.parseInt(grid[4].toString()) : 0);
