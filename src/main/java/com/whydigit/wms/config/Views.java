...
public class Views {
    ...
    private void executeQueries() {
    	...
    	jdbcTemplate.execute("CREATE OR REPLACE  VIEW VW_BO\r\n"
    			+ "(\r\n"
    			+ "   FINYEAR,\r\n"
    			+ "   BRANCHCODE,\r\n"
    			+ "   CLIENT,\r\n"
    			...
    			+ "      WHERE a.buyerorderid = b.buyerorderid AND cancel = 'F'\r\n"
    			+ "   GROUP BY a.finyear,\r\n"
    			+ "            branchcode,\r\n"
    			+ "            client,\r\n"
    			+ "            a.docid,\r\n"
    	...
    	jdbcTemplate.execute("CREATE OR REPLACE  VIEW VW_PR\r\n"
    			+ "(\r\n"
    			+ "   FINYR,\r\n"
    			+ "   BRANCHCODE,\r\n"
    			+ "   CSHORT,\r\n"
    			...
    			+ "      WHERE c.pickrequestid = d.pickrequestid AND c.cancel = 'F'\r\n"
    			+ "   GROUP BY c.finyear,\r\n"
    			+ "            c.branchcode,\r\n"
    			+ "            c.client,\r\n"
    			+ "            c.customername,\r\n"
