...
public class Views {
    ...
    private void executeQueries() {
    	...
    	jdbcTemplate.execute("create or replace view wv_locationstatus as\r\n"
    			...
    			+ "    hh.core AS core,\r\n"
    			+ "    hh.binstatus AS binstatus from (\r\n"
    			+ "SELECT \r\n"
    			+ "    a.orgid AS orgid,\r\n"
    			+ "    a.branch AS branch,\r\n"
    			+ "    a.branchcode AS branchcode,\r\n"
    			...
    			+ "        stockdetails.orgid, \r\n"
    			+ "        stockdetails.branch, \r\n"
    			+ "        stockdetails.branchcode, \r\n"
    			+ "        stockdetails.warehouse, \r\n"
    			+ "        stockdetails.client, \r\n"
    			+ "        stockdetails.binclass, \r\n"
    			+ "        stockdetails.bin, \r\n"
    			+ "        stockdetails.bintype, \r\n"
    			+ "        stockdetails.core, \r\n"
    			+ "        stockdetails.celltype\r\n"
    			+ "    ) a \r\n"
    			+ "UNION ALL \r\n"
    			+ "SELECT \r\n"
    			...
    			+ "    vw_clientbindetails.bincategory AS binclass,\r\n"
    			...
    			+ "WHERE\r\n"
    			+ "    CONCAT(\r\n"
    			+ "        vw_clientbindetails.orgid,\r\n"
    			+ "        vw_clientbindetails.branch,\r\n"
    			+ "        vw_clientbindetails.branchcode,\r\n"
    			+ "        vw_clientbindetails.warehouse,\r\n"
    			+ "        vw_clientbindetails.client,\r\n"
    			+ "        vw_clientbindetails.bin\r\n"
    			+ "    ) NOT IN (\r\n"
    			+ "        SELECT \r\n"
    			+ "            CONCAT(\r\n"
    			+ "                stockdetails.orgid,\r\n"
