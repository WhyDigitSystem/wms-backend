...
@Entity
@Table(name = "srsexcelupload")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class SrsExcelUploadVO {
    
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "srsexceluploadgen")
    @SequenceGenerator(name = "srsexceluploadgen", sequenceName = "srsexceluploadseq", initialValue = 1000000001, allocationSize = 1)
    @Column(name = "srsexceluploadid")
    private Long id;
    ...
    @Column(name = "fromstatus",length =25)
    private String fromStatus;
    
    @Column(name = "tostatus",length =25)
