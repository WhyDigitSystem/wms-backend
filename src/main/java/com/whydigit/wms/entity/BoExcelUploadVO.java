...
public class BoExcelUploadVO {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "boexceluploadgen")
	@SequenceGenerator(name = "boexceluploadgen", sequenceName = "boexceluploadseq", initialValue = 1000000001, allocationSize = 1)
	@Column(name = "boexceluploadid")
	private Long id;
